...
class SentenceInputToplevel(customtkinter.CTkToplevel):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.instruction_font = customtkinter.CTkFont(family='Roboto', size=16)
        self.warning_font = customtkinter.CTkFont(family='Roboto', size=14)
        ...
        self.input_box.grid(row=1, column=0, pady=(10, 5))

        self.password_label = customtkinter.CTkTextbox(self, font=self.word_font, width=500, height=200)
        ...
        def display_password():
            ...
            if password_output != '':
                ...
                for index, warning in enumerate(logic.check_password_strength(None, password_output)):
                    ...
                    self.warning_labels[index].grid(row=3 + index, column=0)
            else:
